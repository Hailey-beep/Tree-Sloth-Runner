...
var buttonImg, restartImg, pauseImg, unpauseImg, slothAni, slothIdle, treeImg, branch1Img, branch2Img, appleImg, bananaImg, orangeImg;
...
function draw() {
  ...
  if(gameState === 1) {
    ...
    //Speed
    var time = Math.round(getFrameRate()/60) 
    branchGro.setVelocityYEach(4 + time/100);
    fruitGro.setVelocityYEach(4 + time/100);
 ...
 if (gameState === 3) {
   textSize(40)
   text("GAME OVER", displayWidth/2-70, displayHeight/5);
 }
